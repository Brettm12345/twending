...
function FieldError({
  ...
  const content = useMemo(() => {
    ...
    // biome-ignore lint/suspicious/noDoubleEquals: This is a valid use case
    ...
    return (
      <ul className="ml-4 flex list-disc flex-col gap-1">
        {uniqueErrors.map(
          (error, index) =>
            error?.message && (
              // biome-ignore lint/suspicious/noArrayIndexKey: The index is used to create a unique key
