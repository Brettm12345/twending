...
type TaskEither<
  E,
  A
> = import('fp-ts/lib/TaskEither').TaskEither<E, A>
type TaskOption<
  A
> = import('fp-ts-contrib/lib/TaskOption').TaskOption<A>
type TaskEitherOption<E, A> = TaskEither<E, Option<A>>
type IO<A> = import('fp-ts/lib/IO').IO<A>
type NonEmptyArray<
  A
> = import('fp-ts/lib/NonEmptyArray').NonEmptyArray<A>

type Lazy<A> = import('fp-ts/lib/function').Lazy<A>
type Predicate<A> = import('fp-ts/lib/function').Predicate<
  A
>
type Refinement<
  A,
  B
> = import('fp-ts/lib/function').Refinement<A, B>
type Endomorphism<
  A
> = import('fp-ts/lib/function').Endomorphism<A>
